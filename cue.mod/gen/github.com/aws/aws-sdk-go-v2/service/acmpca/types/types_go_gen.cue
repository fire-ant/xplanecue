...
#AccessDescription: {
	...
	AccessLocation?: null | #GeneralName @go(,*GeneralName)

	// The type and format of AccessDescription information.
	//
	// This member is required.
	AccessMethod?: null | #AccessMethod @go(,*AccessMethod)
}
...
#AccessMethod: {
	...
	CustomObjectIdentifier?: null | string @go(,*string)
}
...
#ApiPassthrough: {
	...
	Extensions?: null | #Extensions @go(,*Extensions)
	...
	Subject?: null | #ASN1Subject @go(,*ASN1Subject)
}
...
#ASN1Subject: {
	...
	// located.
	Country?: null | string @go(,*string)

	// Disambiguating information for the certificate subject.
	DistinguishedNameQualifier?: null | string @go(,*string)
	...
	GenerationQualifier?: null | string @go(,*string)

	// First name.
	GivenName?: null | string @go(,*string)
	...
	Pseudonym?: null | string @go(,*string)

	// The certificate serial number.
	SerialNumber?: null | string @go(,*string)
...
#CertificateAuthority: {
	...
	CertificateAuthorityConfiguration?: null | #CertificateAuthorityConfiguration @go(,*CertificateAuthorityConfiguration)
	...
	LastStateChangeAt?: null | time.Time @go(,*time.Time)
	...
	OwnerAccount?: null | string @go(,*string)
	...
	// action.
	RestorableUntil?: null | time.Time @go(,*time.Time)
	...
	RevocationConfiguration?: null | #RevocationConfiguration @go(,*RevocationConfiguration)

	// Serial number of your private CA.
	Serial?: null | string @go(,*string)
...
#CertificateAuthorityConfiguration: {
	...
	// signing request (CSR).
	CsrExtensions?: null | #CsrExtensions @go(,*CsrExtensions)
}
...
#CrlConfiguration: {
	...
	CustomCname?: null | string @go(,*string)

	// Validity period of the CRL in days.
	ExpirationInDays?: null | int32 @go(,*int32)
...
#CsrExtensions: {
	...
	// certificate.
	KeyUsage?: null | #KeyUsage @go(,*KeyUsage)
	...
	SubjectInformationAccess: [...#AccessDescription] @go(,[]AccessDescription)
}
...
#EdiPartyName: {
	...
	//
	// This member is required.
	PartyName?: null | string @go(,*string)

	// Specifies the name assigner.
	NameAssigner?: null | string @go(,*string)
}
...
#ExtendedKeyUsage: {
	...
	ExtendedKeyUsageObjectIdentifier?: null | string @go(,*string)
...
#Extensions: {
	...
	// certificate.
	CertificatePolicies: [...#PolicyInformation] @go(,[]PolicyInformation)

	// Specifies additional purposes for which the certified public key may be used
	// other than basic purposes indicated in the KeyUsage extension.
	ExtendedKeyUsage: [...#ExtendedKeyUsage] @go(,[]ExtendedKeyUsage)
	...
	SubjectAlternativeNames: [...#GeneralName] @go(,[]GeneralName)
}
...
#GeneralName: {
	...
	// must contain an X.500 distinguished name (DN). A DN is a sequence of relative
	// distinguished names (RDNs). The RDNs are separated by commas in the certificate.
	DirectoryName?: null | #ASN1Subject @go(,*ASN1Subject)

	// Represents GeneralName as a DNS name.
	DnsName?: null | string @go(,*string)

	// Represents GeneralName as an EdiPartyName object.
	EdiPartyName?: null | #EdiPartyName @go(,*EdiPartyName)

	// Represents GeneralName as an IPv4 or IPv6 address.
	IpAddress?: null | string @go(,*string)

	// Represents GeneralName using an OtherName object.
	OtherName?: null | #OtherName @go(,*OtherName)

	// Represents GeneralName as an object identifier (OID).
	RegisteredId?: null | string @go(,*string)

	// Represents GeneralName as an RFC 822 (https://tools.ietf.org/html/rfc822) email
	// address.
	Rfc822Name?: null | string @go(,*string)

	// Represents GeneralName as a URI.
	UniformResourceIdentifier?: null | string @go(,*string)
}
...
#OcspConfiguration: {
	...
	OcspCustomCname?: null | string @go(,*string)
}
...
#Permission: {
	...
	Actions: [...#ActionType] @go(,[]ActionType)

	// The Amazon Resource Number (ARN) of the private CA from which the permission was
	// issued.
	CertificateAuthorityArn?: null | string @go(,*string)

	// The time at which the permission was created.
	CreatedAt?: null | time.Time @go(,*time.Time)

	// The name of the policy that is associated with the permission.
	Policy?: null | string @go(,*string)
	...
	SourceAccount?: null | string @go(,*string)
}
...
#PolicyInformation: {
	...
	//
	// This member is required.
	CertPolicyId?: null | string @go(,*string)

	// Modifies the given CertPolicyId with a qualifier. ACM Private CA supports the
	// certification practice statement (CPS) qualifier.
	PolicyQualifiers: [...#PolicyQualifierInfo] @go(,[]PolicyQualifierInfo)
}
...
#PolicyQualifierInfo: {
	...
	//
	// This member is required.
	Qualifier?: null | #Qualifier @go(,*Qualifier)
}
...
#RevocationConfiguration: {
	...
	CrlConfiguration?: null | #CrlConfiguration @go(,*CrlConfiguration)
	...
	OcspConfiguration?: null | #OcspConfiguration @go(,*OcspConfiguration)
}
