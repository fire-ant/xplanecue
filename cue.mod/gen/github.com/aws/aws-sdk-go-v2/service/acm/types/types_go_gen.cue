...
#CertificateDetail: {
	...
	DomainValidationOptions: [...#DomainValidation] @go(,[]DomainValidation)
	...
	ExtendedKeyUsages: [...#ExtendedKeyUsage] @go(,[]ExtendedKeyUsage)
	...
	ImportedAt?: null | time.Time @go(,*time.Time)
	...
	KeyUsages: [...#KeyUsage] @go(,[]KeyUsage)
	...
	Options?: null | #CertificateOptions @go(,*CertificateOptions)
	...
	RenewalSummary?: null | #RenewalSummary @go(,*RenewalSummary)
	...
	// certificate status is REVOKED.
	RevokedAt?: null | time.Time @go(,*time.Time)

	// The serial number of the certificate.
	Serial?: null | string @go(,*string)

	// The algorithm that was used to sign the certificate.
	SignatureAlgorithm?: null | string @go(,*string)
	...
	SubjectAlternativeNames: [...string] @go(,[]string)
...
#DomainValidation: {
	...
	ResourceRecord?: null | #ResourceRecord @go(,*ResourceRecord)

	// The domain name that ACM used to send domain validation emails.
	ValidationDomain?: null | string @go(,*string)

	// A list of email addresses that ACM used to send domain validation emails.
	ValidationEmails: [...string] @go(,[]string)
...
#ExpiryEventsConfiguration: {
	...
	DaysBeforeExpiry?: null | int32 @go(,*int32)
}
...
#Filters: {
	...
	ExtendedKeyUsage: [...#ExtendedKeyUsageName] @go(,[]ExtendedKeyUsageName)
	...
	KeyTypes: [...#KeyAlgorithm] @go(,[]KeyAlgorithm)

	// Specify one or more KeyUsage extension values.
	KeyUsage: [...#KeyUsageName] @go(,[]KeyUsageName)
}
