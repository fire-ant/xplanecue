...
#QueueConfiguration: {
	...
	// +optional
	queueArnRef?: null | xpv1.#Reference @go(QueueArnRef,*xpv1.Reference)

	// QueueArnSelector selects a reference to an Queue to retrieve its ARN
	// +optional
	queueArnSelector?: null | xpv1.#Selector @go(QueueArnSelector,*xpv1.Selector)
}
...
#TopicConfiguration: {
	...
	// +optional
	topicRef?: null | xpv1.#Reference @go(TopicArnRef,*xpv1.Reference)

	// TopicArnSelector selects a reference to an SNS Topic to retrieve its Arn
	// +optional
	topicSelector?: null | xpv1.#Selector @go(TopicArnSelector,*xpv1.Selector)
}
