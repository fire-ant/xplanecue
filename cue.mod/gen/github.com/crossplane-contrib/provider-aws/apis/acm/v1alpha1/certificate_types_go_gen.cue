...
#CertificateParameters: {
	...
	certificateTransparencyLoggingPreference?: null | types.#CertificateTransparencyLoggingPreference @go(CertificateTransparencyLoggingPreference,*types.CertificateTransparencyLoggingPreference)
	...
	validationMethod?: null | types.#ValidationMethod @go(ValidationMethod,*types.ValidationMethod)
