...
#CustomComputeEnvironmentParameters: {
	...
	// the ServiceRoleARN.
	// +optional
	serviceRoleARNRef?: null | xpv1.#Reference @go(ServiceRoleARNRef,*xpv1.Reference)

	// ServiceRoleARNSelector selects references to an ARN of the IAM role used
	// to set the ServiceRoleARN.
	// +optional
	serviceRoleARNSelector?: null | xpv1.#Selector @go(ServiceRoleARNSelector,*xpv1.Selector)
	...
	// the InstanceRole.
	// +optional
	instanceRoleRef?: null | xpv1.#Reference @go(InstanceRoleRef,*xpv1.Reference)

	// InstanceRoleSelector selects references to the IAM InstanceProfile used
	// to set the InstanceRole.
	// +optional
	instanceRoleSelector?: null | xpv1.#Selector @go(InstanceRoleSelector,*xpv1.Selector)
	...
	// +optional
	spotIAMFleetRoleRef?: null | xpv1.#Reference @go(SpotIAMFleetRoleRef,*xpv1.Reference)

	// SpotIAMFleetRoleSelector selects references to an ARN of the IAM role used
	// to set the SpotIAMFleetRole.
	// +optional
	spotIamFleetRoleSelector?: null | xpv1.#Selector @go(SpotIAMFleetRoleSelector,*xpv1.Selector)
...
#CustomComputeEnvironmentOrder: {
	...
	// +optional
	computeEnvironmentRef?: null | xpv1.#Reference @go(ComputeEnvironmentRef,*xpv1.Reference)

	// ComputeEnvironmentsSelector selects a reference to ComputeEnvironment used
	// to set the ComputeEnvironment.
	// +optional
	computeEnvironmentSelector?: null | xpv1.#Selector @go(ComputeEnvironmentSelector,*xpv1.Selector)
