...
#NodeGroupParameters: {
	...
	// +immutable
	// +optional
	nodeRoleRef?: null | xpv1.#Reference @go(NodeRoleRef,*xpv1.Reference)

	// NodeRoleSelector selects references to a Cluster used
	// to set the NodeRole.
	// +optional
	nodeRoleSelector?: null | xpv1.#Selector @go(NodeRoleSelector,*xpv1.Selector)
...
#LaunchTemplateSpecification: {
	...
	// +immutable
	// +optional
	nameRef?: null | xpv1.#Reference @go(NameRef,*xpv1.Reference)

	// NameSelector selects references to a LaunchTemplate used
	// to set the Name.
	// +optional
	nameSelector?: null | xpv1.#Selector @go(NameSelector,*xpv1.Selector)
	...
	// +immutable
	// +optional
	versionRef?: null | xpv1.#Reference @go(VersionRef,*xpv1.Reference)

	// VersionSelector selects references to a LaunchTemplateVersion used
	// to set the Version.
	// +optional
	versionSelector?: null | xpv1.#Selector @go(VersionSelector,*xpv1.Selector)
}
...
#RemoteAccessConfig: {
	...
	// +optional
	sourceSecurityGroupRefs?: [...xpv1.#Reference] @go(SourceSecurityGroupRefs,[]xpv1.Reference)

	// SourceSecurityGroupSelector selects references to SecurityGroups used
	// to set the SourceSecurityGroups.
	// +optional
	sourceSecurityGroupSelector?: null | xpv1.#Selector @go(SourceSecurityGroupSelector,*xpv1.Selector)
}
