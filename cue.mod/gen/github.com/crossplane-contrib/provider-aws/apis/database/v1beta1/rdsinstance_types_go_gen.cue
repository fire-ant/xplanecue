...
#S3RestoreBackupConfiguration: {
	...
	// +immutable
	// +optional
	ingestionRoleARNRef?: null | xpv1.#Reference @go(IngestionRoleARNRef,*xpv1.Reference)

	// IngestionRoleARNSelector selects a reference to a IAM Role used to
	// set IngestionRoleARN.
	// +immutable
	// +optional
	ingestionRoleARNSelector?: null | xpv1.#Selector @go(IngestionRoleARNSelector,*xpv1.Selector)
...
#RDSInstanceParameters: {
	...
	// +optional
	// +immutable
	masterPasswordSecretRef?: null | xpv1.#SecretKeySelector @go(MasterPasswordSecretRef,*xpv1.SecretKeySelector)
