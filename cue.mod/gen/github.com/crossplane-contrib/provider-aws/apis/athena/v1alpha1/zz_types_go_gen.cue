...
// +kubebuilder:skipversion
#PreparedStatement: {
	lastModifiedTime?: null | metav1.#Time @go(LastModifiedTime,*metav1.Time)
...
#QueryExecutionStatus: {
	completionDateTime?: null | metav1.#Time @go(CompletionDateTime,*metav1.Time)
	stateChangeReason?:  null | string       @go(StateChangeReason,*string)
	submissionDateTime?: null | metav1.#Time @go(SubmissionDateTime,*metav1.Time)
}
