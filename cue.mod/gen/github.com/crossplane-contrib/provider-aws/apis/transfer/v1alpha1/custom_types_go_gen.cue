...
#CustomUserParameters: {
	...
	// +optional
	serverIDRef?: null | xpv1.#Reference @go(ServerIDRef,*xpv1.Reference)

	// ServerIDSelector selects references to an server instance.
	// +optional
	serverIDSelector?: null | xpv1.#Selector @go(ServerIDSelector,*xpv1.Selector)
...
#CustomServerParameters: {
	...
	// +optional
	certificateRef?: null | xpv1.#Reference @go(CertificateRef,*xpv1.Reference)

	// CertificateSelector selects references to a Certificate.
	// +optional
	certificateSelector?: null | xpv1.#Selector @go(CertificateSelector,*xpv1.Selector)
	...
	// +optional
	loggingRoleRef?: null | xpv1.#Reference @go(LoggingRoleRef,*xpv1.Reference)

	// LoggingRoleSelector selects references to a IAM role.
	// +optional
	loggingRoleSelector?: null | xpv1.#Selector @go(LoggingRoleSelector,*xpv1.Selector)
}
...
#CustomEndpointDetails: {
	...
	// +optional
	addressAllocationIDRefs?: [...xpv1.#Reference] @go(AddressAllocationIDRefs,[]xpv1.Reference)

	// AddressAllocationIDSelector selects references to AddressAllocationID used
	// to set the AddressAllocationIDs.
	// +optional
	addressAllocationIDSelector?: null | xpv1.#Selector @go(AddressAllocationIDSelector,*xpv1.Selector)
	...
	// +optional
	vpcEndpointIDRef?: null | xpv1.#Reference @go(VPCEndpointIDRef,*xpv1.Reference)

	// VPCEndpointIDSelector selects references to a VPCEndpointID.
	// +optional
	vpcEndpointIDSelector?: null | xpv1.#Selector @go(VPCEndpointIDSelector,*xpv1.Selector)
