...
#ReplicationGroupParameters: {
	...
	// +immutable
	// +optional
	cacheSecurityGroupNameRefs?: [...xpv1.#Reference] @go(CacheSecurityGroupNameRefs,[]xpv1.Reference)

	// CacheSecurityGroupNameSelector selects references to SecurityGroups.
	// +immutable
	// +optional
	cacheSecurityGroupNameSelector?: null | xpv1.#Selector @go(CacheSecurityGroupNameSelector,*xpv1.Selector)
	...
	// +immutable
	// +optional
	cacheSubnetGroupNameRef?: null | xpv1.#Reference @go(CacheSubnetGroupNameRef,*xpv1.Reference)
	...
	// +immutable
	// +optional
	cacheSubnetGroupNameRefs?: null | xpv1.#Reference @go(DeprecatedCacheSubnetGroupNameRef,*xpv1.Reference)

	// CacheSubnetGroupNameSelector selects a reference to a CacheSubnetGroup.
	// +immutable
	// +optional
	cacheSubnetGroupNameSelector?: null | xpv1.#Selector @go(CacheSubnetGroupNameSelector,*xpv1.Selector)
