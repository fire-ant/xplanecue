...
#AthenaIntegration: {
	...
	partitionEndDate?:                  null | metav1.#Time @go(PartitionEndDate,*metav1.Time)
	partitionStartDate?:                null | metav1.#Time @go(PartitionStartDate,*metav1.Time)
}
...
#CapacityReservation: {
	...
	endDate?:                    null | metav1.#Time @go(EndDate,*metav1.Time)
...
#ClientData: {
	...
	uploadEnd?:   null | metav1.#Time @go(UploadEnd,*metav1.Time)
	uploadSize?:  null | float64      @go(UploadSize,*float64)
	uploadStart?: null | metav1.#Time @go(UploadStart,*metav1.Time)
}
...
#DescribeFastLaunchImagesSuccessItem: {
	...
	stateTransitionTime?:   null | metav1.#Time @go(StateTransitionTime,*metav1.Time)
}

// +kubebuilder:skipversion
#DescribeFastSnapshotRestoreSuccessItem: {
	availabilityZone?:      null | string       @go(AvailabilityZone,*string)
	disabledTime?:          null | metav1.#Time @go(DisabledTime,*metav1.Time)
	disablingTime?:         null | metav1.#Time @go(DisablingTime,*metav1.Time)
	enabledTime?:           null | metav1.#Time @go(EnabledTime,*metav1.Time)
	enablingTime?:          null | metav1.#Time @go(EnablingTime,*metav1.Time)
	optimizingTime?:        null | metav1.#Time @go(OptimizingTime,*metav1.Time)
...
#EBSInstanceBlockDevice: {
	attachTime?:          null | metav1.#Time @go(AttachTime,*metav1.Time)
	deleteOnTermination?: null | bool         @go(DeleteOnTermination,*bool)
...
#ElasticInferenceAcceleratorAssociation: {
	...
	elasticInferenceAcceleratorAssociationTime?:  null | metav1.#Time @go(ElasticInferenceAcceleratorAssociationTime,*metav1.Time)
}
...
// +kubebuilder:skipversion
#Host: {
	allocationTime?:                     null | metav1.#Time @go(AllocationTime,*metav1.Time)
	availabilityZone?:                   null | string       @go(AvailabilityZone,*string)
	availabilityZoneID?:                 null | string       @go(AvailabilityZoneID,*string)
	clientToken?:                        null | string       @go(ClientToken,*string)
	...
	ownerID?:                            null | string       @go(OwnerID,*string)
	releaseTime?:                        null | metav1.#Time @go(ReleaseTime,*metav1.Time)
	tags?: [...null | #Tag] @go(Tags,[]*Tag)
}
...
#HostReservation: {
	...
	duration?:       null | int64        @go(Duration,*int64)
	end?:            null | metav1.#Time @go(End,*metav1.Time)
	hourlyPrice?:    null | string       @go(HourlyPrice,*string)
	instanceFamily?: null | string       @go(InstanceFamily,*string)
	start?:          null | metav1.#Time @go(Start,*metav1.Time)
	tags?: [...null | #Tag] @go(Tags,[]*Tag)
	upfrontPrice?: null | string @go(UpfrontPrice,*string)
}
...
// +kubebuilder:skipversion
#IDFormat: {
	deadline?:   null | metav1.#Time @go(Deadline,*metav1.Time)
...
#IPamAddressHistoryRecord: {
	...
	sampledEndTime?:   null | metav1.#Time @go(SampledEndTime,*metav1.Time)
	sampledStartTime?: null | metav1.#Time @go(SampledStartTime,*metav1.Time)
	vpcID?:            null | string       @go(VPCID,*string)
}
...
#ImageRecycleBinInfo: {
	...
	imageID?:             null | string       @go(ImageID,*string)
	name?:                null | string       @go(Name,*string)
	recycleBinEnterTime?: null | metav1.#Time @go(RecycleBinEnterTime,*metav1.Time)
	recycleBinExitTime?:  null | metav1.#Time @go(RecycleBinExitTime,*metav1.Time)
}
...
#InstanceStatusDetails: {
	impairedSince?: null | metav1.#Time @go(ImpairedSince,*metav1.Time)
}
...
#InstanceStatusEvent: {
	...
	notBeforeDeadline?: null | metav1.#Time @go(NotBeforeDeadline,*metav1.Time)
}
...
#ProvisionedBandwidth: {
	provisionTime?: null | metav1.#Time @go(ProvisionTime,*metav1.Time)
	provisioned?:   null | string       @go(Provisioned,*string)
	requestTime?:   null | metav1.#Time @go(RequestTime,*metav1.Time)
...
#ReservedInstancesModification: {
	clientToken?:                     null | string       @go(ClientToken,*string)
	createDate?:                      null | metav1.#Time @go(CreateDate,*metav1.Time)
	effectiveDate?:                   null | metav1.#Time @go(EffectiveDate,*metav1.Time)
...
#ScheduledInstance: {
	...
	nextSlotStartTime?:           null | metav1.#Time @go(NextSlotStartTime,*metav1.Time)
	platform?:                    null | string       @go(Platform,*string)
	previousSlotEndTime?:         null | metav1.#Time @go(PreviousSlotEndTime,*metav1.Time)
	scheduledInstanceID?:         null | string       @go(ScheduledInstanceID,*string)
	slotDurationInHours?:         null | int64        @go(SlotDurationInHours,*int64)
	termEndDate?:                 null | metav1.#Time @go(TermEndDate,*metav1.Time)
	termStartDate?:               null | metav1.#Time @go(TermStartDate,*metav1.Time)
...
#ScheduledInstanceAvailability: {
	availabilityZone?:            null | string       @go(AvailabilityZone,*string)
	availableInstanceCount?:      null | int64        @go(AvailableInstanceCount,*int64)
	firstSlotStartTime?:          null | metav1.#Time @go(FirstSlotStartTime,*metav1.Time)
	hourlyPrice?:                 null | string       @go(HourlyPrice,*string)
	instanceType?:                null | string       @go(InstanceType,*string)
...
// +kubebuilder:skipversion
#SnapshotTierStatus: {
	archivalCompleteTime?:             null | metav1.#Time @go(ArchivalCompleteTime,*metav1.Time)
	...
	lastTieringStartTime?:             null | metav1.#Time @go(LastTieringStartTime,*metav1.Time)
	ownerID?:                          null | string       @go(OwnerID,*string)
	restoreExpiryTime?:                null | metav1.#Time @go(RestoreExpiryTime,*metav1.Time)
	snapshotID?:                       null | string       @go(SnapshotID,*string)
	tags?: [...null | #Tag] @go(Tags,[]*Tag)
	volumeID?: null | string @go(VolumeID,*string)
}
...
#VGWTelemetry: {
	...
	certificateARN?:     null | string       @go(CertificateARN,*string)
	lastStatusChange?:   null | metav1.#Time @go(LastStatusChange,*metav1.Time)
	outsideIPAddress?:   null | string       @go(OutsideIPAddress,*string)
	statusMessage?:      null | string       @go(StatusMessage,*string)
}
...
// +kubebuilder:skipversion
#VolumeModification: {
	endTime?:                    null | metav1.#Time @go(EndTime,*metav1.Time)
