...
#SecurityGroupRuleParameters: {
	...
	// +kubebuilder:validation:Optional
	// +immutable
	securityGroupIdRef?: null | xpv1.#Reference @go(SecurityGroupIDRef,*xpv1.Reference)
	...
	// +kubebuilder:validation:Optional
	sourceSecurityGroupIdRef?: null | xpv1.#Reference @go(SourceSecurityGroupIDRef,*xpv1.Reference)

	// +kubebuilder:validation:Optional
	sourceSecurityGroupIdSelector?: null | xpv1.#Selector @go(SourceSecurityGroupIDSelector,*xpv1.Selector)
}
