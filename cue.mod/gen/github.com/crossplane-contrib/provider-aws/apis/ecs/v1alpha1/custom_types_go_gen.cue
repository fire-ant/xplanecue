...
#CustomLoadBalancer: {
	...
	loadBalancerNameRef?:      null | xpv1.#Reference @go(LoadBalancerNameRef,*xpv1.Reference)
	loadBalancerNameSelector?: null | xpv1.#Selector  @go(LoadBalancerNameSelector,*xpv1.Selector)
...
#CustomServiceParameters: {
	...
	clusterRef?:      null | xpv1.#Reference @go(ClusterRef,*xpv1.Reference)
	clusterSelector?: null | xpv1.#Selector  @go(ClusterSelector,*xpv1.Selector)
	...
	taskDefinitionRef?:      null | xpv1.#Reference @go(TaskDefinitionRef,*xpv1.Reference)
	taskDefinitionSelector?: null | xpv1.#Selector  @go(TaskDefinitionSelector,*xpv1.Selector)
}
...
#CustomEFSAuthorizationConfig: {
	...
	accessPointIDRef?:      null | xpv1.#Reference @go(AccessPointIDRef,*xpv1.Reference)
	accessPointIDSelector?: null | xpv1.#Selector  @go(AccessPointIDSelector,*xpv1.Selector)
...
#CustomTaskDefinitionParameters: {
	...
	taskRoleARNRef?:      null | xpv1.#Reference @go(TaskRoleARNRef,*xpv1.Reference)
	taskRoleARNSelector?: null | xpv1.#Selector  @go(TaskRoleARNSelector,*xpv1.Selector)
