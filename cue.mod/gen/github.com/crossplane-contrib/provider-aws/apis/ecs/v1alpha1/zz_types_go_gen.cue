...
#ContainerInstance: {
	...
	pendingTasksCount?:    null | int64        @go(PendingTasksCount,*int64)
	registeredAt?:         null | metav1.#Time @go(RegisteredAt,*metav1.Time)
	runningTasksCount?:    null | int64        @go(RunningTasksCount,*int64)
	status?:               null | string       @go(Status,*string)
...
#Deployment: {
	...
	updatedAt?:            null | metav1.#Time          @go(UpdatedAt,*metav1.Time)
}
...
// +kubebuilder:skipversion
#ManagedAgent: {
	lastStartedAt?: null | metav1.#Time @go(LastStartedAt,*metav1.Time)
	lastStatus?:    null | string       @go(LastStatus,*string)
	reason?:        null | string       @go(Reason,*string)
}
...
#Task: {
	...
	capacityProviderName?: null | string       @go(CapacityProviderName,*string)
	clusterARN?:           null | string       @go(ClusterARN,*string)
	connectivityAt?:       null | metav1.#Time @go(ConnectivityAt,*metav1.Time)
	containerInstanceARN?: null | string       @go(ContainerInstanceARN,*string)
	cpu?:                  null | string       @go(CPU,*string)
	createdAt?:            null | metav1.#Time @go(CreatedAt,*metav1.Time)
	...
	executionStoppedAt?: null | metav1.#Time      @go(ExecutionStoppedAt,*metav1.Time)
	...
	platformFamily?:  null | string       @go(PlatformFamily,*string)
	platformVersion?: null | string       @go(PlatformVersion,*string)
	pullStartedAt?:   null | metav1.#Time @go(PullStartedAt,*metav1.Time)
	pullStoppedAt?:   null | metav1.#Time @go(PullStoppedAt,*metav1.Time)
	...
	stoppingAt?:      null | metav1.#Time @go(StoppingAt,*metav1.Time)
	tags?: [...null | #Tag] @go(Tags,[]*Tag)
	taskARN?:           null | string @go(TaskARN,*string)
...
#TaskDefinition_SDK: {
	...
	cpu?:            null | string       @go(CPU,*string)
	deregisteredAt?: null | metav1.#Time @go(DeregisteredAt,*metav1.Time)
...
#TaskSet: {
	...
	stabilityStatusAt?: null | metav1.#Time @go(StabilityStatusAt,*metav1.Time)
	startedBy?:         null | string       @go(StartedBy,*string)
	status?:            null | string       @go(Status,*string)
	tags?: [...null | #Tag] @go(Tags,[]*Tag)
	taskDefinition?: null | string       @go(TaskDefinition,*string)
