...
#IPConfiguration: {
	...
	// +optional
	privateNetworkRef?: null | xpv1.#Reference @go(PrivateNetworkRef,*xpv1.Reference)

	// PrivateNetworkSelector selects a PrivateNetworkRef.
	// +optional
	privateNetworkSelector?: null | xpv1.#Selector @go(PrivateNetworkSelector,*xpv1.Selector)
