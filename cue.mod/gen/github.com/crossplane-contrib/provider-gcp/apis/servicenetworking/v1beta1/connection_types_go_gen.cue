...
#ConnectionParameters: {
	...
	// +optional
	reservedPeeringRangeRefs?: [...xpv1.#Reference] @go(ReservedPeeringRangeRefs,[]xpv1.Reference)

	// ReservedPeeringRangeSelector selects a set of references to GlobalAddress
	// objects.
	// +optional
	reservedPeeringRangeSelector?: xpv1.#Selector @go(ReservedPeeringRangeSelector)
}
