...
#SubnetSpec: {
	...
	virtualNetworkNameRef?: null | xpv1.#Reference @go(VirtualNetworkNameRef,*xpv1.Reference)

	// VirtualNetworkNameSelector selects a reference to a VirtualNetwork to
	// retrieve its name
	virtualNetworkNameSelector?: null | xpv1.#Selector @go(VirtualNetworkNameSelector,*xpv1.Selector)
